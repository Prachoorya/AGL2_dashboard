...
import { armezoFrontendApplications } from "../../data/data";
import { Box, Typography, List, ListItem, ListItemText, ListItemIcon } from "@mui/material";
import BulletIcon from "@mui/icons-material/FiberManualRecord";

const ApplicationTable_1 = ({ selectedFrontend, navigate }) => {
    ...
    const applications = armezoFrontendApplications.find(
...
export default ApplicationTable_1;