...
import { phoenixBusinessAreaApplications } from "../../data/data";
import { Box, Typography, List, ListItem, ListItemText, ListItemIcon } from "@mui/material";
import BulletIcon from "@mui/icons-material/FiberManualRecord";

const PhoenixApplication_3 = ({ selectedBusinessArea, navigate }) => {
    ...
    const applications = phoenixBusinessAreaApplications.find(
...
export default PhoenixApplication_3;