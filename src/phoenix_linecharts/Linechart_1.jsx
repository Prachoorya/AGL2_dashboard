...
import { phoenixFrontendLineData as data } from "../../data/data";
import { useNavigate } from "react-router-dom";
import PhoenixApplication_1 from "../../table/phoenix/frontend_applications";
...
const LineChart1 = () => {
  ...
  return (
   ...
   <Modal open={showPopUp} onClose={handleClosePopup}>
        ...
        >
            <PhoenixApplication_1 selectedFrontend={selectedFrontend?.xFormatted} navigate={navigate} />
        </Box>
     </Modal>
    </>
  );
