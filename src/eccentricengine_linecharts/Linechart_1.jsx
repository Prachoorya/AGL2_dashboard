...
import { eccentricEngineAreaLineData as data } from "../../data/data";
...
const LineChart1 = () => {
  ...
  return (
   ...
   <Modal open={showPopUp} onClose={handleClosePopup}>
        ...
        >
            <EccentricApplication_1 selectedBusinessArea={selectedBusinessArea?.xFormatted} navigate={navigate} />
        </Box>
     </Modal>
    </>
  );
