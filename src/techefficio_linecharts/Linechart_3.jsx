...
import { techAreaLineData as data } from "../../data/data";
import { useNavigate } from "react-router-dom";
import TechApplication_3 from "../../table/techefficio/area_applications";
...
const LineChart3 = () => {
  ...
  return (
   ...
   <Modal open={showPopUp} onClose={handleClosePopup}>
        ...
        >
            <TechApplication_3 selectedBusinessArea={selectedBusinessArea?.xFormatted} navigate={navigate} />
        </Box>
     </Modal>
    </>
  );
