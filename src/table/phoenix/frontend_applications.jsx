...
import { phoenixFrontendApplications } from "../../data/data";
import { Box, Typography, List, ListItem, ListItemText, ListItemIcon } from "@mui/material";
import BulletIcon from "@mui/icons-material/FiberManualRecord";

const PhoenixApplication_1 = ({ selectedFrontend, navigate }) => {
    ...
    const applications = phoenixFrontendApplications.find(
...
export default PhoenixApplication_1;