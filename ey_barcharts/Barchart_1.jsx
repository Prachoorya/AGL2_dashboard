...
import { eyFrontendData as data, eyFrontendApplications } from "../../data/data";
import { useNavigate } from "react-router-dom";
import EyApplication_1 from "../../table/ey/frontend_applications";
...
const BarChart1 = () => {
    ...
    />
     ...
     <Modal open={showPopUp} onClose={handleClosePopup}>
        ...
        >
            <EyApplication_1 selectedFrontend={selectedFrontend} navigate={navigate} />
        </Box>
     </Modal>
    </>
  );
