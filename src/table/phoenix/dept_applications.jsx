...
import { phoenixDepartmentApplications } from "../../data/data";
import { Box, Typography, List, ListItem, ListItemText, ListItemIcon } from "@mui/material";
import BulletIcon from "@mui/icons-material/FiberManualRecord";

const PhoenixApplication_4 = ({ selectedDepartment, navigate }) => {
    ...
    const applications = phoenixDepartmentApplications.find(
...
export default PhoenixApplication_4;