...
import { techDepartmentApplications } from "../../data/data";
import { Box, Typography, List, ListItem, ListItemText, ListItemIcon } from "@mui/material";
import BulletIcon from "@mui/icons-material/FiberManualRecord";

const TechApplication_4 = ({ selectedDepartment, navigate }) => {
    ...
    const applications = techDepartmentApplications.find(
...
export default TechApplication_4;