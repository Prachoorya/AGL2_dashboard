...
import { eyAreaLineData as data } from "../../data/data";
import { useNavigate } from "react-router-dom";
import EyApplication_3 from "../../table/ey/area_applications";
...
const LineChart3 = () => {
  ...
  return (
   ...
   <Modal open={showPopUp} onClose={handleClosePopup}>
        ...
        >
            <EyApplication_3 selectedBusinessArea={selectedBusinessArea?.xFormatted} navigate={navigate} />
        </Box>
     </Modal>
    </>
  );
