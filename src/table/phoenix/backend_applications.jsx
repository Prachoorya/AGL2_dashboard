...
import { phoenixBackendApplications } from "../../data/data";
import { Box, Typography, List, ListItem, ListItemText, ListItemIcon } from "@mui/material";
import BulletIcon from "@mui/icons-material/FiberManualRecord";

const PhoenixApplication_2 = ({ selectedBackend, navigate }) => {
    ...
    const applications = phoenixBackendApplications.find(
...
export default PhoenixApplication_2;