...
import { eyBusinessAreaApplications } from "../../data/data";
import { Box, Typography, List, ListItem, ListItemText, ListItemIcon } from "@mui/material";
import BulletIcon from "@mui/icons-material/FiberManualRecord";

const EyApplication_3 = ({ selectedBusinessArea, navigate }) => {
    ...
    const applications = eyBusinessAreaApplications.find(
...
export default EyApplication_3;