...
import { nagarroDepartmentApplications } from "../../data/data";
import { Box, Typography, List, ListItem, ListItemText, ListItemIcon } from "@mui/material";
import BulletIcon from "@mui/icons-material/FiberManualRecord";

const Application_4 = ({ selectedDepartment, navigate }) => {
    ...
    const applications = nagarroDepartmentApplications.find(
