...
import { aglDepartmentApplications } from "../../data/data";
import { Box, Typography, List, ListItem, ListItemText, ListItemIcon } from "@mui/material";
import BulletIcon from "@mui/icons-material/FiberManualRecord";

const ApplicationTable4 = ({ selectedDepartment, navigate }) => {
    ...
    const applications = aglDepartmentApplications.find(
...
export default ApplicationTable4;