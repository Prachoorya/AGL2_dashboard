...
import { mockFrontendLineData as data } from "../../data/data";
import { useNavigate } from "react-router-dom";
import ApplicationTable2 from "../../table/agl/frontend_applications";
...
const LineChart_2 = () => {
  ...
  return (
   ...
   <Modal open={showPopUp} onClose={handleClosePopup}>
        ...
        >
            <ApplicationTable2 selectedFrontend={selectedFrontend?.xFormatted} navigate={navigate} />
        </Box>
     </Modal>
    </>
  );
