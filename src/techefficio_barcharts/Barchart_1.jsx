...
import { techFrontendData as data, techFrontendApplications } from "../../data/data";
import { useNavigate } from "react-router-dom";
import TechApplication_1 from "../../table/techefficio/frontend_applications";
...
const BarChart1 = () => {
    ...
    />
     ...
     <Modal open={showPopUp} onClose={handleClosePopup}>
        ...
        >
            <TechApplication_1 selectedFrontend={selectedFrontend} navigate={navigate} />
        </Box>
     </Modal>
    </>
    );
