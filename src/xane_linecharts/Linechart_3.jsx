...
import { xaneAreaLineData as data } from "../../data/data";
import { useNavigate } from "react-router-dom";
import XaneApplication_3 from "../../table/xane/area_applications";
...
const LineChart3 = () => {
  ...
  return (
   ...
   <Modal open={showPopUp} onClose={handleClosePopup}>
        ...
        >
            <XaneApplication_3 selectedBusinessArea={selectedBusinessArea?.xFormatted} navigate={navigate} />
        </Box>
     </Modal>
    </>
  );
