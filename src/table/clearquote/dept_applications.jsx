...
import { clearDepartmentApplications } from "../../data/data";
import { Box, Typography, List, ListItem, ListItemText, ListItemIcon } from "@mui/material";
import BulletIcon from "@mui/icons-material/FiberManualRecord";

const ClearApplication_2 = ({ selectedDepartment, navigate }) => {
    ...
    const applications = clearDepartmentApplications.find(
...
export default ClearApplication_2;