...
import { nagarroFrontendLineData as data } from "../../data/data";
import { useNavigate } from "react-router-dom";
import Application_1 from "../../table/nagarro/frontend_applications";
...
const LineChart1 = () => {
  ...
  return (
   ...
   <Modal open={showPopUp} onClose={handleClosePopup}>
        ...
        >
            <Application_1 selectedFrontend={selectedFrontend?.xFormatted} navigate={navigate} />
        </Box>
     </Modal>
    </>
  );
