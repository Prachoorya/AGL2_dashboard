...
import { armezoBusinessAreaApplications } from "../../data/data";
import { Box, Typography, List, ListItem, ListItemText, ListItemIcon } from "@mui/material";
import BulletIcon from "@mui/icons-material/FiberManualRecord";

const ApplicationTable_3 = ({ selectedBusinessArea, navigate }) => {
    ...
    const applications = armezoBusinessAreaApplications.find(
...
export default ApplicationTable_3;