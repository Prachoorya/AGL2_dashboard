...
import { sensegizFrontendLineData as data } from "../../data/data";
import { useNavigate } from "react-router-dom";
import SensegizApplication_1 from "../../table/sensegiz/frontend_applications";
...
const LineChart1 = () => {
  ...
  return (
   ...
   <Modal open={showPopUp} onClose={handleClosePopup}>
        ...
        >
            <SensegizApplication_1 selectedFrontend={selectedFrontend?.xFormatted} navigate={navigate} />
        </Box>
     </Modal>
    </>
  );
