...
import { armezoFrontendLineData as data } from "../../data/data";
import { useNavigate } from "react-router-dom";
import ApplicationTable_1 from "../../table/armezo/frontend_applications";
...
const LineChart1 = () => {
  ...
  return (
   ...
   <Modal open={showPopUp} onClose={handleClosePopup}>
        ...
        >
            <ApplicationTable_1 selectedFrontend={selectedFrontend?.xFormatted} navigate={navigate} />
        </Box>
     </Modal>
    </>
  );
