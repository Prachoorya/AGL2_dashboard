...
import { armezoAreaLineData as data } from "../../data/data";
import { useNavigate } from "react-router-dom";
import ApplicationTable_3 from "../../table/armezo/area_applications";
...
const LineChart3 = () => {
  ...
  return (
   ...
   <Modal open={showPopUp} onClose={handleClosePopup}>
        ...
        >
            <ApplicationTable_3 selectedBusinessArea={selectedBusinessArea?.xFormatted} navigate={navigate} />
        </Box>
     </Modal>
    </>
  );
