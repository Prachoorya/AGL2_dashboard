...
import { techBackendApplications } from "../../data/data";
import { Box, Typography, List, ListItem, ListItemText, ListItemIcon } from "@mui/material";
import BulletIcon from "@mui/icons-material/FiberManualRecord";

const TechApplication_2 = ({ selectedBackend, navigate }) => {
    ...
    const applications = techBackendApplications.find(
...
export default TechApplication_2;