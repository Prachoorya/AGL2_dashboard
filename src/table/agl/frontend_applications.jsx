...
import { aglFrontendApplications } from "../../data/data";
import { Box, Typography, List, ListItem, ListItemText, ListItemIcon } from "@mui/material";
import BulletIcon from "@mui/icons-material/FiberManualRecord";

const ApplicationTable2 = ({ selectedFrontend, navigate }) => {
    ...
    const applications = aglFrontendApplications.find(
...
export default ApplicationTable2;