...
import { techBusinessAreaApplications } from "../../data/data";
import { Box, Typography, List, ListItem, ListItemText, ListItemIcon } from "@mui/material";
import BulletIcon from "@mui/icons-material/FiberManualRecord";

const TechApplication_3 = ({ selectedBusinessArea, navigate }) => {
    ...
    const applications = techBusinessAreaApplications.find(
...
export default TechApplication_3;