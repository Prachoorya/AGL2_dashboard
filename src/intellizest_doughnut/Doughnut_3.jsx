...
import { intellizestAreaDoughnutData as data } from "../../data/data";
...
const Doughnut3 = () => {
   ...
   <Modal open={showPopUp} onClose={handleClosePopup}>
        ...
        >
            <IntellizestApplication_3 selectedBusinessArea={selectedBusinessArea} navigate={navigate} />
        </Box>
     </Modal>
    </>
    );
