...
import { sensegizBackendApplications } from "../../data/data";
import { Box, Typography, List, ListItem, ListItemText, ListItemIcon } from "@mui/material";
import BulletIcon from "@mui/icons-material/FiberManualRecord";

const SensegizApplication_2 = ({ selectedBackend, navigate }) => {
    ...
    const applications = sensegizBackendApplications.find(
...
export default SensegizApplication_2;