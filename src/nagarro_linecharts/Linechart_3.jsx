...
import { nagarroAreaLineData as data } from "../../data/data";
import { useNavigate } from "react-router-dom";
import Application_3 from "../../table/nagarro/area_applications";
...
const LineChart3 = () => {
  ...
  return (
   ...
   <Modal open={showPopUp} onClose={handleClosePopup}>
        ...
        >
            <Application_3 selectedBusinessArea={selectedBusinessArea?.xFormatted} navigate={navigate} />
        </Box>
     </Modal>
    </>
  );
