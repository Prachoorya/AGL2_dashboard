...
import { armezoBackendApplications } from "../../data/data";
import { Box, Typography, List, ListItem, ListItemText, ListItemIcon } from "@mui/material";
import BulletIcon from "@mui/icons-material/FiberManualRecord";

const ApplicationTable_2 = ({ selectedBackend, navigate }) => {
    ...
    const applications = armezoBackendApplications.find(
...
export default ApplicationTable_2;